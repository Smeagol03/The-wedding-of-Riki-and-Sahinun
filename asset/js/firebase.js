...
const firebaseConfig = {
  ...
  appId: "1:307470739649:web:fa7ec97ae911be788e8c40",
};

const app = initializeApp(firebaseConfig);
const db = getDatabase(app);
const komentarRef = ref(db, "SAHINUN");

const form = document.getElementById("commentForm");
const commentsContainer = document.getElementById("listKomentar");
...
onChildAdded(komentarRef, (data) => {
  ...
  div.innerHTML = `
    <div class="flex items-center mb-3">
      ...
      <div class="ml-3">
        <h4 class="font-semibold text-gray-800" style="font-family: 'Poppins', sans-serif;">${nama}</h4>
        <p class="text-xs text-gray-500" style="font-family: 'Poppins', sans-serif;">${waktuFormatted}</p>
      </div>
    </div>
